Shader "AkilliMum/SRP/D2WeatherEffects/2019"
{
    Properties
    {
        ...
        [HideInInspector]_EnableDepth("Enable Depth", Float) = -1.0
        [HideInInspector]_DepthCutoff("Depth Cutoff", Float) = 0.5
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "../Base/LitInput.hlsl"
            #include "../Base/LitForwardPass.hlsl"
        ...
        Pass
        {
            ...
            #include "../Base/LitInput.hlsl"
            #include "../Base/ShadowCasterPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "../Base/LitInput.hlsl"
            #include "../Base/DepthOnlyPass.hlsl"
            ENDHLSL
        }
