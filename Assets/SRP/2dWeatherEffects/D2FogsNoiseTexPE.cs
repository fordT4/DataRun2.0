...
{
    [Serializable]
    [PostProcess(typeof(D2FogsNoiseTexPERenderer), PostProcessEvent.AfterStack, "AkilliMum/SRP/D2WeatherEffects/Post/D2FogsNoiseTexPE")]
    public sealed class D2FogsNoiseTexPE : PostProcessEffectSettings
    {
    ...
    public sealed class D2FogsNoiseTexPERenderer : PostProcessEffectRenderer<D2FogsNoiseTexPE>
    {
