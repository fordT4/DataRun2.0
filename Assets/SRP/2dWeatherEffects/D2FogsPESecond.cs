...
{
    [Serializable]
    [PostProcess(typeof(D2FogsPESecondRenderer), PostProcessEvent.AfterStack, "AkilliMum/SRP/D2WeatherEffects/Post/D2FogsPESecond")]
    ...
    public sealed class D2FogsPESecondRenderer : PostProcessEffectRenderer<D2FogsPESecond>
    {
        ...
        {
            var sheet = context.propertySheets.Get(Shader.Find("Hidden/AkilliMum/SRP/D2WeatherEffects/Post/D2Fogs"));
