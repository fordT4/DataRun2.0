...
{
    [Serializable]
    [PostProcess(typeof(D2FogsNoiseTexPESecondRenderer), PostProcessEvent.AfterStack, "AkilliMum/SRP/D2WeatherEffects/Post/D2FogsNoiseTexPESecond")]
    public sealed class D2FogsNoiseTexPESecond : PostProcessEffectSettings
    {
    ...
    public sealed class D2FogsNoiseTexPESecondRenderer : PostProcessEffectRenderer<D2FogsNoiseTexPESecond>
    {
        ...
        {
            var sheet = context.propertySheets.Get(Shader.Find("Hidden/AkilliMum/SRP/D2WeatherEffects/Post/D2FogsNoiseTex"));
